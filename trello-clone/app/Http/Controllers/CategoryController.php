...
class CategoryController extends Controller
{
    ...
    {
        // Now that we have obtained the token from the previous requests, the next we want to do is to now
        // use the access tokens to make our next request. We are going to make a request to fetch all the categories.
    ...
    /**
     * Show tasks related to specific category
     *
     * @param  \App\Category $category
     * @return \Illuminate\Http\Response
     */
